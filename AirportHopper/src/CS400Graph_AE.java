...
public class CS400Graph_AE<NodeType,EdgeType extends Number> implements GraphADT<NodeType,EdgeType> {
    ...
    public CS400Graph_AE() { vertices = new Hashtable<>(); }
    ...
    protected class MSTEdge implements Comparable<MSTEdge> {
        ...
        /**
         * This method returns a string representation of the current MST edge for debug
         * purposes
         * 
         * @return the string representation of this MST edge
         */
        @Override
        public String toString() {
            return this.start.data.toString() + "-" + String.valueOf(this.weight) + "->" + this.end.data.toString(); 
        }
    }
